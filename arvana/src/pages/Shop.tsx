...
export default function Shop() {
  const { products, categoryNames: categories, rooms, materials } = useProducts();
  ...
  const filtered = useMemo(() => {
    let list = products.filter((p) => {
      if (!isVisibleToCustomers(p)) return false;
    ...
    return list;
  }, [products, search, selectedCategories, selectedRooms, selectedMaterials, collectionFilter, maxPrice, inStockOnly, sort]);
